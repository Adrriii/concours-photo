...
class SqlUserSettingDaoTest {
    ...
    void testUpdateForUser() throws SQLException {
        ...
        User updateUser = new User(testUser.username, settings, 0, 0, 0, 0,testUser.participations, testUser.photo, testUser.photoDelete, testUser.theme,testUser.rank, testUser.id);
